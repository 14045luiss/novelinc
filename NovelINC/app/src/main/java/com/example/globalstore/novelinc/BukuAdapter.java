...
import com.example.globalstore.novelinc.Model.Buku;
...
public class BukuAdapter extends
    ...
    @Override
    public BukuAdapter.BukuViewHolder onCreateViewHolder(ViewGroup parent,
                                                                      int viewType) {
        View view =
                LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_layar_list_buku, parent,
                        false);
       BukuViewHolder mHolder = new BukuViewHolder(view);
        return mHolder;
    }
    @Override
    public void onBindViewHolder(BukuAdapter.BukuViewHolder holder, final
    int position) {
        ...
        //    Picasso.with(holder.itemView.getContext()).load(ApiClient.BASE_URL+listPembeli.get(position).getPhotoId()).into(holder.mPhotoURL);
            Glide.with(holder.itemView.getContext()).load(listBuku.get
    ...
    public class BukuViewHolder extends RecyclerView.ViewHolder {
        ...
        public BukuViewHolder(View itemView) {
            ...
            tvPenulis = (TextView) itemView.findViewById(R.id.tvPenulisContent);
            tvPenerbit = (TextView) itemView.findViewById(R.id.tvPenerbitContent);
            tvTahunTerbit = (TextView) itemView.findViewById(R.id.tvTahunTerbitContent);
